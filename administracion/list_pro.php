      ...
      <table id="example" class="display" style="width:100%">
             ...
             <tbody>
                 <?php 
                      ...
                      $productos=mysqli_query($conexion,"SELECT * FROM tienda_productos WHERE status=1");
                      $n=0; 
                      ...
                      while ($m_productos=mysqli_fetch_array($productos)) { $n=$n+1;?>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            ...
                            <?php } ?></td>
                          <td style="text-align: center;"><?php if ($m_productos[14]==1) { ?>
                            <i class="fa fa-star"></i>
                            <?php } ?>
                            <?php if ($m_productos[14]==0) { ?>
                            <?php echo $var=' '; ?>
                            <?php } ?></td>
                  
                          <td style="text-align: center;"><button class="btn btn-warning btn-small" title="Destacar" onclick="destacar('<?php echo $m_productos[0]; ?>')"><i class="fa fa-star"></i></button> <button class="btn btn-default btn-small" title="Desactivar" onclick="activar('<?php echo $m_productos[0]; ?>')"><i class="fa fa-exchange-alt"></i></button> <button class="btn btn-info btn-small" title="Ver Detalles" onclick="detalles_pro('<?php echo $m_productos[0]; ?>')" data-toggle="modal" data-target="#detallesp"><i class="fa fa-eye"></i></button> <button class="btn btn-danger btn-small" title="Eliminar Producto" onclick="borrar_pro('<?php echo $m_productos[0]; ?>')"><i class="fa fa-times"></i></button></td>
                        </tr>
...
<div id="detallesp" class="modal hide fade in col-lg-6" tabindex="-1" role="dialog" aria-labelledby="detalles" aria-hidden="false"  >
