                  ...
                  ?>
                    <div class="col-md-3 col-sm-3">
                         ...
                         <div class="caption">
                           ...
                           <h4 style="text-align:center"><a class="btn btn-default" href="detProduct.php?name=<?php echo $print['nombre'];?>&cdg=<?php echo $print['id_producto'];?>"> <i class="fa fa-search"></i></a> <a href="AccionCarta.php?action=addToCart&id=<?php echo $print["id_producto"]; ?>" class="btn btn-default" >Añadir <i class="fa fa-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><?php echo $v_money['signo']." :". number_format($print['precio'],2,',','.');?> </a></h4>
                         </div>
                      </div>
                      </div><!--END DIV MD--->
